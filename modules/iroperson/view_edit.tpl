...
{saddr_entry e="displayname" label="Displayname"}
...
{saddr_entry e="work_telephone" label="Telephone" labelonview=1 multi=1 type="phone"}
...
{saddr_entry e="home_country" label="Country"
  type="sselect" module="country"
  format="@name@" want="code"}
{saddr_entry e="home_telephone" label="Telephone" labelonview=1 multi=1 type="phone"}
